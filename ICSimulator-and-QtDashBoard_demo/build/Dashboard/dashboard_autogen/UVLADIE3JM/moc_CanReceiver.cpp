...
#include <memory>
#include "../../../../Dashboard/src/CanReceiver.h"
...
QT_MOC_LITERAL(10, 101, 12) // "readCanFrame"

    },
    "CanReceiver\0speedDataReceived\0\0speed\0"
    "rpmDataReceived\0rpm\0fuelDataReceived\0"
    "fuel\0tempDataReceived\0temp\0readCanFrame"
};
...
void CanReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->readCanFrame(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CanReceiver::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanReceiver::speedDataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CanReceiver::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanReceiver::rpmDataReceived)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CanReceiver::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanReceiver::fuelDataReceived)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (CanReceiver::*)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanReceiver::tempDataReceived)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void CanReceiver::speedDataReceived(float _t1)
{
...
// SIGNAL 1
void CanReceiver::rpmDataReceived(float _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void CanReceiver::fuelDataReceived(float _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void CanReceiver::tempDataReceived(float _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
